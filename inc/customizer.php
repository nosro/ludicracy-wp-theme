 ...
 */
function orson_customize_preview_js() {
	wp_enqueue_script( 'orson-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'orson_customize_preview_js' );
